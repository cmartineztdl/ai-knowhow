...
- **Block 0: Foundations — How LLMs Actually Work**
  ...
  - 💻 [Do the Exercises](pathname:///exercises/block-00/)
  - ✅ [View the Solutions](pathname:///solutions/block-00/)
...
- **Block 1: Talking to Models — APIs & SDKs**
  ...
  - 💻 [Do the Exercises](pathname:///exercises/block-01/)
  - ✅ [View the Solutions](pathname:///solutions/block-01/)

- **Block 2: Prompt Engineering**
  The art and science of getting the output you actually want.
  - 📖 [Read the Theory](./docs/block-02/)
  - 💻 [Do the Exercises](pathname:///exercises/block-02/)
  - ✅ [View the Solutions](pathname:///solutions/block-02/)
