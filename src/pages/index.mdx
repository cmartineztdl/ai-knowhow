...
keywords: [ai, artificial intelligence, course, free, llm, openai, anthropic, prompt engineering, tutorial, javascript, typescript]
---
...
- **Content** — Core concepts and detailed explanations of how AI models work.

## 🗺️ Course Blocks

### Available Now

- 📖 **[Block 0: Foundations: How LLMs Actually Work](./docs/block-00/)** — Before using AI tools effectively you need a mental model of what is happening under the hood.
- 📖 **[Block 1: Talking to Models: APIs & SDKs](./docs/block-01/)** — Hands-on interaction with LLM APIs from JavaScript/TypeScript.
- 📖 **[Block 2: Prompt Engineering](./docs/block-02/)** — The art and science of getting the output you actually want.
- 📖 **[Block 10: Agent Security & Governance](./docs/block-10/)** — Advanced controls and security measures for autonomous AI systems.
...
<a href="https://buymeacoffee.com/cmartineztdl" target="_blank">
